...
<head>
  ...
  <title>CourierManagementSystem</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="Home.jsp">Courier Management System</a></h1>
 ...
 <section id="contact" class="contact" style="background-color:#000;">
      <div class="container">
        ...
        <div class="section-title">
          <h2><span>Track</span> Product</h2>
          
        </div>
 
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for product number..." title="Type in a name">
...
<table class="table table-bordered">
							...
							<TR>
								...
								<li><a href="CourierDetails.jsp?hashcode=<%=rs.getString(25)%>"><%=rs.getString(25)%></li>
