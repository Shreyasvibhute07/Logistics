...
<!-- ======= Contact Section ======= -->
    <section id="contact" class="contact">
      <div class="container">
		...
		<div>
<h3><b><center><font color="#000" face="times new roman">View Users</font></center></b></h3>
...
<table class="table table-bordered">
							...
							<TR>
							 ...
							 <td><a href="DeleteRequestCon?id=<%=rs.getInt(1)%>"><img alt="" src="assets/img/delete.jpg" width="25px;" height="25px;"><b></b></a></td> 
